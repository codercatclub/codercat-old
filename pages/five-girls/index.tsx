...
export default function Leilani() {
  ...
  return (
    <div className={bg}>
      <video className={vid} autoPlay muted={muted} loop controls>
      ...
      <div className={about}>
        ...
        <p className={par}>
          5 Girls 5 Rooms, a live performance piece done at <a className={ln} href='https://mars.college/' target='_blank'>Mars College</a>,
